...
For each of the following propositions we are to prove or disprove them. Let \(G\) be a connected undirected weighted graph.
...
\begin{enumerate}
	...
	\item
		...
		\paragraph{Proof.} This proposition is true. We shall prove it by contradiction. Suppose the contrary; i.e. there exist two spanning trees \(T_1\) and \(T_2\) such that \(T_1 \neq T_2\).
